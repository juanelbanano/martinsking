...
// Toggle fundacion fields
function toggleFundacionFields(val) {
    var parentGroup    = document.getElementById('parent-name-group');
    var studentLabel   = document.getElementById('student-name-label');
    var emailLabel     = document.getElementById('email-label');
    var phoneLabel     = document.getElementById('phone-label');
    var emailInput     = document.getElementById('email');
    var parentInput    = document.getElementById('parent-name');

    if (val === 'fundacion') {
        // Cambiar labels
        studentLabel.textContent = 'Nombre del Mayor de Edad *';
        emailLabel.textContent   = 'Gmail de la Persona a Cargo *';
        phoneLabel.textContent   = 'Teléfono de la Persona a Cargo *';
        // Ocultar campo padre/tutor
        parentGroup.style.display = 'none';
        parentInput.removeAttribute('required');
        // Asegurar que email sea requerido
        emailInput.setAttribute('required', 'required');
    } else {
        // Restaurar labels originales
        studentLabel.textContent = 'Nombre del Estudiante *';
        emailLabel.textContent   = 'Email *';
        phoneLabel.textContent   = 'Teléfono *';
        // Mostrar campo padre/tutor
